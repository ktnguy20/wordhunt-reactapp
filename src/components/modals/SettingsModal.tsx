...
type SettingsModalProps = {
  isOpen: boolean;
  handleClose: () => void;
  handleRestart: (newSize: number, newTimeLimit: number) => void;
  darkMode: boolean;
  toggleDarkMode: () => void;
  size: number;
...
const SettingsModal = memo(
    function SettingsModal({
      ...
      const MaterialUIButtonGroupStyle = {
        ...
        '&& .Mui-selected:hover': {
          backgroundColor:
            darkMode ? 'rgba(119, 136, 153, 0.9)' : 'rgba(0, 0, 0, 0.12)',
          borderColor: darkMode ? 'inherit': 'undefined',
          color: darkMode ? 'inherit': undefined,
        },
        '&& .Mui-focus': {
        ...
        '&& :hover': {
          backgroundColor:
            darkMode ? 'rgba(119, 136, 153, 0.3)' : 'rgba(0, 0, 0, 0.04)',
          borderColor: darkMode ? 'inherit': 'undefined',
          color: darkMode ? 'inherit': undefined,
        },
      };
      ...
      const handleSaveSettings = () => {
        ...
        handleClose();
        handleRestart(newSize, newTimeLimit);
      };
